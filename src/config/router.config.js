...
export const asyncRouterMap = [

  {
    ...
    children: [
      ...
      {
        path: '/form5',
        redirect: '/form/base-form51',
        component: PageView,
        meta: { title: '付费服务', icon: 'form', permission: ['form'] },
        children: [
          {
            path: '/form/base-form51',
            name: 'BaseForm',
            component: () => import('@/views/form/BasicForm'),
